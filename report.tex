...
\begin{document}
  ...
  \lstinputlisting[caption=3\_9.py, label=program7]{./3_9.py}
  また，ionosphere.scaleの読み込みにあたって，欠番のパラメータを0で補完するなどの処理を行うため，読み込み部分は別のプログラム\ref{program8}として分離した．
  \lstinputlisting[caption=load\_ionosphere.py, label=program8]{./load_ionosphere.py}
  ...
  \lstinputlisting[caption=3\_10.py, label=program9]{./3_10.py}
  ...
  \lstinputlisting[caption=calc\_fgprint.py, label=calc]{./calc_fgprint.py}
  ...
  \lstinputlisting[caption=4\_14.py, label=code414]{./4_14.py}
  ...
  \lstinputlisting[caption=4\_15.py, label=code415]{./4_15.py}
  ...
  \lstinputlisting[caption=4\_16.py, label=code416]{./4_16.py}
